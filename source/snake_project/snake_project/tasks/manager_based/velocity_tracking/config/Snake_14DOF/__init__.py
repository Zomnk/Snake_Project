...
gym.register(
    id="Snake-14DOF-VelocityTracking-Flat-v0",
...
gym.register(
    id="Snake-14DOF-VelocityTracking-Flat-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Snake-14DOF-VelocityTracking-Rough-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:SnakeVelocityFlatEnvCfg",
...
gym.register(
    id="Snake-14DOF-VelocityTracking-Rough-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.flat_env_cfg:SnakeVelocityFlatEnvCfg_PLAY",
